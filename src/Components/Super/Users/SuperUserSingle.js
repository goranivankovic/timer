...
import superUsersStyles from '../../../Styles/Users/SuperUsersFind.module.css'

import { useSelector } from 'react-redux' 

function SuperUserSingle({...navData}) {
...
<div className={superUsersStyles.thredText}>
 Find User by Id number 
  ...
  <button className={superUsersStyles.button} onClick={findAdminSingle}>Find Admin</button>
...
export default SuperUserSingle