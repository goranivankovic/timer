...
import superUsersStyles from '../../../Styles/Users/SuperUsersUpdate.module.css'

import { useSelector } from 'react-redux'

function SuperUserUpdate({...navData}) {
...
const i6=document.getElementById('i6').value=''
    ...
    setTimeout(() => {
      navigate('/dashboard/admin/super/users/update')
    }, 1000);
...
<input type="text" id='i1'  className={superUsersStyles.input} placeholder='New cardId' onChange={(c)=>{setCardId(c.target.value)}}   />

  <input type="text" id='i2'   className={superUsersStyles.input} placeholder="New name"  onChange={(a)=>{setName(a.target.value)}} />


 <input type="text" id='i3'   className={superUsersStyles.input} placeholder='New lastname' onChange={(b)=>{setLastName(b.target.value)}} />
...
<input type="text"  id='i4'   className={superUsersStyles.input} placeholder="New  position"  onChange={(a)=>{setPosition(a.target.value)}} />
...
<input type="date" placeholder='Join'  className={superUsersStyles.input} onChange={(b)=>{setYearsActive(b.target.value)}} />
  ...
  <input type="text" id='i5'   className={superUsersStyles.input} placeholder="New paycheck"  onChange={(a)=>{setPaycheck(a.target.value)}} />


 <input type="text" id='i6'   className={superUsersStyles.input} placeholder='New overtime' onChange={(b)=>{setOverTime(b.target.value)}}    />
  ...
  <button className={superUsersStyles.button}  onClick={updateAdmin}>Update</button>
